...
Before diving into analysis, we need to prepare your images. Here’s what you need to get your data ready for processing:
   ...
   - #### 1.1 Stain the histological images of interest for CD31
   The first step is to obtain histological images of interest. These images should be stained for CD31, a marker for endothelial cells that line blood vessels. This staining is essential for enhancing vessel contrast and enabling analyses further down the pipeline. Finally, the slides need to be scanned digitally for further evaluation.
